      ...
      <div class="main-content">
        ...
        <div class="recordSteps autoIndex">
          ...
          <ul>
            <li>
              1.
              以V0.5.0为例，打开晓阳AI助手后，使用企业微信扫码登录，登录成功后进入首页
              <div>
                <img
        ...
        <div class="recordSteps autoRecord">
          ...
          <ul>
            ...
            <li>
              3.
              点击录制按钮后，屏幕右下角会录制工作区，这三个按钮，从左到右分别是停止、录制、返回按钮
            </li>
            <li>
              4.
              点击录制按钮后开始自动记录操作步骤，等待识别完成将录下下一个步骤
              <div class="tip-box">
        ...
        <div class="recordSteps autoAdd">
          ...
          <ul>
            <li>
              1. 点击下方添加步骤按钮，在弹出的插件指令中选择对应指令
              <div class="imgStyle">
                <img src="@/assets/auto-addstep.png" alt="" />
              </div>
            </li>
            <li>
              2.
              将鼠标悬浮到已添加的步骤上时，会自动悬浮显示添加按钮，点击后即可在插入在该步骤后面，添加新步骤再执行
              <br />
              <div class="imgStyle">
